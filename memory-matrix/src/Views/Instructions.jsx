...
function Instructions() {
  ...
  const toggleConsiderations = () => {
    setConsiderationsExpanded(!considerationsExpanded);
  };
  ...
  return (
    <>
      ...
      <div className="container-instructions">
        ...
        <p onClick={toggleBonus} className="instruction-title">
          Bonus
        </p>
        {bonusExpanded && (
          <ul className="instruction-content">
        ...
        <p onClick={toggleConsiderations} className="instruction-title">
          Consideraciones
        </p>
