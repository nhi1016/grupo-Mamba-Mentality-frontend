...
function Instructions() {
    return(
        ...
        <ul>
            <li> El juego tendrá un sistema de ayudas que permita al jugador terminarlo y no quedarse estancado, estos pueden ser: 

            Transcurrido un tiempo de inactividad, un número limitado de tarjetas mostrarán pistas, que será una breve descripción de la imagen al reverso. 

            La ficha se tornará transparente permitiendo vislumbrar algo del dibujo. </li>

            <li>Un turno consistirá en una partida, de la cual el jugador conseguirá una cantidad de puntos según los criterios especificados a continuación: 

            Mientras menos se demore más puntos recibirá. 

            Según el tamaño del tablero, más grande, más puntos. 

            Mientras menos BONUS use más puntos recibe. 

            Mientras mayor dificultad, más puntos recibe. </li>
